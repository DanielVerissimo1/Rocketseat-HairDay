...
**Hair Day** é uma aplicação web de agendamento de cortes de cabelo, desenvolvida como um dos projetos da formação de **JavaScript** na Rocketseat, com foco na criação de aplicações interativas e dinâmicas.
